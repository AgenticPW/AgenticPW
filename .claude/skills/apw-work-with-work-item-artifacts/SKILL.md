---
description: Defines where a work item's artifacts live. Use as the single source of truth for the location of research, brainstorm, requirements, design, plan, root-cause, verification, and review and other "apw-skills" documents.
